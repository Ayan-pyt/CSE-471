      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/admin-dashboard" element={
            <PrivateRoute element={<AdminDashboard />} roles={['university_admin','system_admin']} />
          } />
          ...
          <Route path="/learning-path/:internshipId" element={
            <PrivateRoute element={<LearningRecommendations />} roles={['student']} />
          } />
        </Routes>
      </BrowserRouter>
    </AuthProvider>
